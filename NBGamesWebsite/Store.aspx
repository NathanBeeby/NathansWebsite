<%@ Page Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="Store.aspx.cs" Inherits="HorseTherapySite.Store" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="centerBar">
        <div class="row">
            <div class="col-md-12">
                <%-- Add repeater with a layout for items in the market place, add different categories, bind different table to repeater for each button click and site --%>
