<%@ Page Title="TempGame4" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="TempGame4.aspx.cs" Inherits="HorseTherapySite.SharedTherapy" %>
        ...
        <div class="col-md-12">
            <div style="padding-top:20px;padding-bottom:20px;padding-left:40px;padding-right:40px">
                <div style="background-color:white;padding:20px;border-radius:25px;height:auto;">
                    <h2 style="text-align:center;"><u>Temp Game 3</u></h2>
