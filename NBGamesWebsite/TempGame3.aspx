<%@ Page Title="TempGame3" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="TempGame3.aspx.cs" Inherits="HorseTherapySite.FamilyTherapy" %>
...
<hd:Header runat="server" ID="HeaderScroller" />
   ...
   <div class="centerBar">
        <div class="row">
            <div class="col-md-12">
                <h2 style="text-align:center;color:white;"><u>Temp Game 3</u></h2>
                <div class="col-md-6">
